...
subtitle: "⚔\ :raw-html-m2r:`<br/>`\ module Ressource R5.VCOD.06"
...
.. image:: https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Git-logo.svg/512px-Git-logo.svg.png
   :target: https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Git-logo.svg/512px-Git-logo.svg.png
   :alt: Git Logo
...
#. 
   **Index (Staging Area)** : C'est une zone intermédiaire où sont placés les fichiers modifiés avant d'être enregistrés dans le dépôt. C'est ici que vous préparez vos modifications avant de les valider avec la commande ``git commit``.  

#. 
   **Historique des commits** : Chaque commit est un instantané des modifications du projet à un moment donné. Un commit contient des informations sur ce qui a changé, qui l'a modifié, et quand ces modifications ont été faites.  
...
.. image:: https://api.updevcommunity.com/assets/18288git-338f.jpg
   :target: https://api.updevcommunity.com/assets/18288git-338f.jpg
   :alt: Git + GitHub
...
* Ouvrez votre navigateur web et allez sur le site officiel de GitHub : `https://github.com <https://github.com>`_.
...
.. image:: https://www.gnu.org/licenses/license-list.html
   :target: https://www.gnu.org/licenses/license-list.html
   :alt: license
...
#. 
   **GNU General Public License (GPL)** : Cette licence oblige à rendre publique toute modification du code sous la même licence. Elle est souvent utilisée pour garantir que le logiciel reste libre et open-source.
   ...
   .. image:: images/gpl2.png
      :target: images/gpl2.png
      :alt: Syntaxe markdown


   .. image:: images/gpl2_lic.png
      :target: images/gpl2_lic.png
      :alt: Syntaxe markdown
...
#. 
   **Apache License 2.0** : Similaire à la licence MIT, mais avec des clauses supplémentaires, notamment une protection contre les revendications de brevets.
   ...
   .. image:: images/apache.png
      :target: images/apache.png
      :alt: Syntaxe markdown


   .. image:: images/apche_lic.png
      :target: images/apche_lic.png
      :alt: Syntaxe markdown
...
#. 
   Lorsque vous créez un nouveau dépôt sur GitHub, il vous est proposé d’ajouter une licence.  

#. 
   Si vous avez déjà un dépôt sans licence, vous pouvez ajouter un fichier nommé ``LICENSE`` dans le répertoire racine du dépôt.  

#. 
   Utilisez l’outil **Choose a License** de GitHub (\ `chooselicense.com <https://choosealicense.com>`_\ ) pour vous aider à sélectionner la licence qui correspond le mieux à vos besoins.  
...
.. image:: images/fsociety.png
   :target: images/fsociety.png
   :alt: Alt text de l'image
...
`Aller à la section Titres <#titres-headings>`_  
...
* Ou bien, utilisez le lien direct : `Créer un nouveau dépôt <https://github.com/new>`_.  
...
#. 
   **Connectez-vous à GitHub** : Accédez à `GitHub <https://github.com/>`_ et connectez-vous à votre compte.
...
.. image:: https://www.ifourtechnolab.com/pics/All_about_Version_ControlGit.webp
   :target: https://www.ifourtechnolab.com/pics/All_about_Version_ControlGit.webp
   :alt: GitHub
...
#. Rendez-vous sur la page du **GitHub Student Developer Pack** : `https://education.github.com/pack <https://education.github.com/pack>`_.
#. Cliquez sur "Get your Pack".
#. Vérifiez votre statut étudiant en fournissant une **adresse e-mail académique** ou une **preuve d'inscription** (une photo de votre carte d'étudiant par exemple).
#. Une fois validé, vous aurez accès aux outils et services inclus dans le Pack.
...
#. 
   Ouvrez les fichiers pour voir les sections en conflit.  

#. 
   Modifiez manuellement le fichier pour résoudre le conflit.  

#. 
   Ajoutez les fichiers résolus (\ ``git add``\ ).  

#. 
   Continuez le rebase ou le merge (\ ``git rebase --continue`` ou ``git merge --continue``\ ).  

#. 
   Poussez ensuite vos modifications (\ ``git push``\ ).  
